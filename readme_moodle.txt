...
* remove folder theme/roc/scss/bootstrap
* copy the scss files from ~/bootstrap/scss to theme/roc/scss/bootstrap
...
* comment out this line in theme/roc/scss/_print.scss
    @page {
...
* copy the js files from ~/bootstrap/js/src to theme/roc/amd/src/bootstrap (including the subfolder)
...
* in folder theme/roc run "Grunt amd" to compile the bootstrap JS
