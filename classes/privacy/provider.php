...
/**
 * Privacy Subsystem implementation for theme_roc.
 *
 * @package    theme_roc
...
/**
 * The roc theme stores a user preference data.
 *
 * @copyright  2021 Peter Meint Heida
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class provider implements
    ...
    public static function export_user_preferences(int $userid) {
        ...
        if (isset($draweropennavpref)) {
            $preferencestring = get_string('privacy:drawernavclosed', 'theme_roc');
            if ($draweropennavpref == 'true') {
                $preferencestring = get_string('privacy:drawernavopen', 'theme_roc');
            }
